...
# this function formatting the results we fetch from OWM
...
def get_weather(place: str):
    try:
        ...
        r = f"Rain: {'there is no rain today' if wt.rain == {} else wt.rain}\n"
        wn = f"Wind: {wt.wind()['speed']} m/s \n"
    except Exception:
        return 'This place was not found, try again'
    else: 
